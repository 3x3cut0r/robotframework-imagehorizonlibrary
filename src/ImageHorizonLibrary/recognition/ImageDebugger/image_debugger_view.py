"""Tkinter view used by the image debugger GUI."""
...
class UILocatorView(Tk):
    """Visual representation of the image debugger."""

    def __init__(self, controller, image_container, image_horizon_instance):
        """Initialise the debugger window and build widgets."""
        super().__init__()
    ...
    def _create_view(self):
        """Assemble the view from individual frames."""
        self._menu()
        self._frame_main()
    ...
    def _menu(self):
        """Create menu bar with a help link."""
        # ***************** Menu ******************* #
        menu = Menu(self)
    ...
    def _frame_load_reference_image(self):
        """Frame containing reference image selection widgets."""
        # ************ Frame Select image ************ #
    ...
    def _frame_computation_params(self):
        """Frame with parameter controls for recognition strategies."""
        # ************ Frame Computation ************ #
    ...
    def _frame_results(self):
        """Frame displaying recognition results and keyword snippet."""
        # ************ Frame Results ************ #
    ...
    def _frame_image_viewer(self):
        """Frame hosting small previews of desktop and reference images."""
        # ************ Image viewer ************ #
    ...
    def _status_bar(self):
        """Create the status bar used for context hints."""
    ...
    def _img_viewer_click(self, event=None):
        """Open the desktop image in a new window when clicked."""
    ...
    def _img_viewer_hover_enter(self, event=None):
        """Show hint when hovering over the desktop image preview."""
        if (self.processing_done):
